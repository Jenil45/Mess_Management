...
function Alert({alert,setalert}) {
  ...
  return (
<div
  className={` hidden w-full items-center ${alert.type} p-3 max-w-[100%] rounded-lg bg-warning-100 mt-2 mb-4 text-base text-warning-800 data-[te-alert-show]:inline-flex`}
  role="alert"
  data-te-alert-init
  data-te-alert-show>
  {alert.message}
