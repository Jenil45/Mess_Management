...
const MultiSelect = ({ thing, setMenu, Menu }) => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col gap-[1rem] mt-5 items-center justify-start pt-4 w-[23rem] h-[30rem] border border-black rounded shadow-xl ">
        <h1 className="text-center h5">Add {thing} </h1>
        <div className="w-[30rem] flex flex-col gap-[2rem] items-center justify-center">
          <div className="p-[1rem] flex items-center gap-[1rem]">
            ...
            <button
              onClick={addOption}
              className="group rounded-full w-10 h-10 flex-[2] bg-green-500 font-bold text-lg text-white relative overflow-hidden"
            >
              +
            </button>
          </div>
